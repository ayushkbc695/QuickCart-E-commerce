...
const About = () => {
  return (
    <div>
      ...
      <div className='flex flex-col gap-5 md:flex-row text-sm mb-20'>

        <div className='border border-gray-200 rounded px-10 md:px-16 py-8 sm:px-20 flex flex-col gap-5'> 
